...
(function (undefined) {
    ...
    ************************************/
    ...
    extend(Locale.prototype, {
        ...
        _weekdays : 'Sonntag_Montag_Dienstag_Mittwoch_Donnerstag_Freitag_Samstag'.split('_'),
        weekdays : function (m) {
            return this._weekdays[m.day()];
        },

        _weekdaysShort : 'Son_Mon_Die_Mit_Don_Fre_Sam'.split('_'),
        weekdaysShort : function (m) {
            return this._weekdaysShort[m.day()];
        },

        _weekdaysMin : 'So_Mo_Di_Mi_Do_Fr_Sa'.split('_'),
